        ...
        <div className="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-lg border border-default">
            <div className="p-4 flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                    <button className="inline-flex items-center gap-2 text-sm px-3 py-2 rounded-md bg-gradient-to-r from-indigo-500 to-purple-500 text-white shadow-sm hover:opacity-95">New Post</button>
